...
description: PRDownloader
img: PRDownloader.png # Add image post (optional)
...
public void onClick(View v) {
	...
	downloadId = PRDownloader.download(URLFile, dirPath, "facebook.apk")
		.build()
...
private String URLFile = "http://www.appsapk.com/downloading/latest/Facebook-119.0.0.23.70.apk";
