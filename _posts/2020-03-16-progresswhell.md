...
description: ProgressWhell
img: ProgressWhell.png # Add image post (optional)
...
public static class ProgressWheel extends View {
  ...
  private void setAnimationEnabled() {
    ...
    if (currentApiVersion >= android.os.Build.VERSION_CODES.JELLY_BEAN_MR1) {
      animationValue = android.provider.Settings.Global.getFloat(getContext().getContentResolver(),
          android.provider.Settings.Global.ANIMATOR_DURATION_SCALE, 1);
    } else {
      animationValue = android.provider.Settings.System.getFloat(getContext().getContentResolver(),
  ...
  public void setIndeterminate(boolean gabriel) {
  	indeterminate = gabriel; 
  }
...
progress.setLayoutParams(new LinearLayout.LayoutParams(android.widget.LinearLayout.LayoutParams.MATCH_PARENT, android.widget.LinearLayout.LayoutParams.MATCH_PARENT));
progress.setRimColor(Color.parseColor("#7986CB"));
progress.spin();
final int defaultBarColor = progress.getBarColor();
progress.setBarColor(0xFF1A237E);
progress.setIndeterminate(true);
progress.setCircleRadius(100);
progress.setBarWidth(12);
progress.setRimWidth(12);
linear1.addView(progress);
