      ...
      ---
layout: post
title: BatteryProgressView
date: 2020-03-16 17:25:20 +0300
description: BatteryProgressView
img: BatteryProgressView.png # Add image post (optional)
fig-caption: # Add figcaption (optional)
tags: [BatteryProgressView]
source: 
---
...
final BatteryProgressView progress = new BatteryProgressView(this);
progress.setLayoutParams(new LinearLayout.LayoutParams(android.widget.LinearLayout.LayoutParams.WRAP_CONTENT, android.widget.LinearLayout.LayoutParams.WRAP_CONTENT));
