...
description: SwipeDismis
img: SwipeDismis.png # Add image post (optional)
...
final ViewGroup dismissableContainer = (ViewGroup) findViewById(R.id.linear1);
for (int i = 0; i < items.length; i++) {
    ...
    button1.setOnTouchListener(new SwipeDismissTouchListener(
           button1,
           null,
           ...
           public void onDismiss(View view, Object token) {
                  dismissableContainer.removeView(button1);
           }
    }));
    dismissableContainer.addView(button1);
    }
```
